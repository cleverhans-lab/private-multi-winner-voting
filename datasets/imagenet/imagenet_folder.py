...
def load_meta_file(root: str, file: Optional[str] = None) -> Tuple[
...
def parse_devkit_archive(root: str, file: Optional[str] = None) -> None:
    ...
    def parse_meta_mat(devkit_root: str) -> Tuple[
...
def parse_train_archive(root: str, file: Optional[str] = None,
                        folder: str = "train") -> None:
    ...
    archives = [os.path.join(train_root, archive) for archive in
                os.listdir(train_root)]
    for archive in archives:
        extract_archive(archive, os.path.splitext(archive)[0],
                        remove_finished=True)


def parse_val_archive(
        root: str, file: Optional[str] = None,
        wnids: Optional[List[str]] = None, folder: str = "val"
) -> None:
